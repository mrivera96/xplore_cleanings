package com.xplorerentacar.xplorelimpiezas
...
import com.xplorerentacar.xplorelimpiezas.services.CustomWebViewClient
import com.xplorerentacar.xplorelimpiezas.services.NetworkStatusManager
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initComponents() {
        ...
        webView.loadUrl("http://192.168.2.119/LimpiezasXplore/index.aspx")
    ...
    private fun checkNetwork() {
        when (NetworkStatusManager.status(Objects.requireNonNull(applicationContext))) {
    ...
    /***
     * MUESTRA EL WEBVIEW QUE CARGA LA PÁGINA DE LIMPIEZAS
     */
